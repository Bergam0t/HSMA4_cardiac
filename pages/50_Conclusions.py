...
site_count = st.radio(
    "Select number of additional sites to see " + "optimal configuration",
    ("One", "Two"),
    horizontal=True,
)
...
if site_count == "One":
    st.markdown(
        "### The optimal configuration with 1 additional site is "
        + "the addition of RWF03: The Maidstone Hospital"
    )

    st.markdown(
        "* Median travel time for Kent and Medway patients reduced "
    ...
    st.markdown(
        "* Travel times would be reduced for 100% of the Kent and "
    ...
    st.markdown(
        "* Travel times would be reduced to less than the national "
    ...
    st.markdown(
        "* Total travel distance (1 way) reduction would be 117,177 "
...
if site_count == "Two":
    st.markdown(
        "### The optimal configuration with 2 additional sites is "
    ...
    st.markdown(
        "* Total travel distance (1 way) reduction would be 134,296 "
        + "km for the period of actuals considered."
    )
